...
- [x] T008 [P] Create `IWarehouseApiService.cs`: `GetAllAsync(bool includeInactive)`, `GetByIdAsync(int id)`, `GetStockAsync(int warehouseId)→List<WarehouseStockSummaryResponse>`, `CreateAsync(...)`, `UpdateAsync(int id, ...)`, `SetDefaultAsync(int id)`.
