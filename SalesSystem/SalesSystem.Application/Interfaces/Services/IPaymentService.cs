...
public interface IPaymentService
{
    ...
    Task<Result<CustomerPaymentDto>> UpdateCustomerPaymentAsync(int id, UpdateCustomerPaymentRequest request, CancellationToken ct);
    Task<Result> DeleteCustomerPaymentAsync(int id, CancellationToken ct);
    ...
    Task<Result<SupplierPaymentDto>> UpdateSupplierPaymentAsync(int id, UpdateSupplierPaymentRequest request, CancellationToken ct);
    Task<Result> DeleteSupplierPaymentAsync(int id, CancellationToken ct);
}
