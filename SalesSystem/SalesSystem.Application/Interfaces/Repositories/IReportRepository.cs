...
{
    // Sales Reports
    Task<IEnumerable<SalesReportDto>> GetSalesReportAsync(DateTime from, DateTime to, CancellationToken ct);
    
    // Purchase Reports
    Task<IEnumerable<PurchaseReportDto>> GetPurchasesReportAsync(DateTime from, DateTime to, CancellationToken ct);
    // Stock Reports
    Task<IEnumerable<StockReportDto>> GetStockReportAsync(int? warehouseId, CancellationToken ct);
    Task<IEnumerable<LowStockReportDto>> GetLowStockReportAsync(CancellationToken ct);
    // Customer Balances
