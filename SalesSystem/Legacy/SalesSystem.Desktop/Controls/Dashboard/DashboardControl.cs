...
public partial class DashboardControl : UserControl
{
    ...
    private void InitializeComponent()
    {
        ...
        cardSales = new SummaryCardControl("„»Ì⁄«  «·ÌÊ„", "0.00", Color.FromArgb(52, 152, 219));
        cardPurchases = new SummaryCardControl("„‘ —Ì«  «·ÌÊ„", "0.00", Color.FromArgb(231, 76, 60));
        cardCustomers = new SummaryCardControl("«·⁄„·«¡ «·‰‘ÿÊ‰", "0", Color.FromArgb(46, 204, 113));
        cardLowStock = new SummaryCardControl("√’‰«› „‰Œ›÷…", "0", Color.FromArgb(241, 196, 15));
        cardReceivables = new SummaryCardControl("≈Ã„«·Ì «·„œÌÊ‰Ì… (·‰«)", "0.00", Color.FromArgb(155, 89, 182));
        cardPayables = new SummaryCardControl("≈Ã„«·Ì «·„œÌÊ‰Ì… (⁄·Ì‰«)", "0.00", Color.FromArgb(52, 73, 94));
        ...
        var lblWelcome = new Label { 
            Text = $"„—Õ»«° {_sessionService.Current?.FullName ?? "«·„” Œœ„"}", 
