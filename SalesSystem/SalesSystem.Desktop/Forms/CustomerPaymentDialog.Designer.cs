namespace SalesSystem.Desktop.Forms
{
    partial class CustomerPaymentDialog
    {
        ...
        private void InitializeComponent()
        {
            ...
            cmbCustomer.Location = new Point(120, 17); cmbCustomer.Size = new Size(240, 27); cmbCustomer.DropDownStyle = ComboBoxStyle.DropDownList;
            ...
            this.Controls.AddRange(new Control[] { lblCustomer, cmbCustomer, lblAmount, numAmount, lblMethod, cmbMethod, lblDate, dtpDate, lblNotes, txtNotes, btnSave, btnCancel });
            this.RightToLeft = RightToLeft.Yes;
            this.RightToLeftLayout = true;
            this.StartPosition = FormStartPosition.CenterParent;
            this.Text = "سند قبض من عميل";
            ((System.ComponentModel.ISupportInitialize)(this.numAmount)).EndInit();
            this.ResumeLayout(false);
            this.PerformLayout();
        }

        private Label lblCustomer, lblAmount, lblMethod, lblDate, lblNotes;
        private ComboBox cmbCustomer, cmbMethod;
