namespace SalesSystem.Desktop.Forms
{
    partial class SalesInvoiceForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.pnlHeader.Controls.AddRange(new Control[] { cmbCustomer, lblCustomer, dtpDate, lblDate, cmbWarehouse, lblWarehouse, cmbPaymentType, lblPaymentType });
        ...
        private ComboBox cmbCustomer, cmbWarehouse, cmbPaymentType;
        private Label lblCustomer, lblDate, lblWarehouse, lblPaymentType, lblNotes, lblSubtotal, lblSubtotalValue, lblDiscount, lblTax, lblTotal, lblTotalValue, lblPaid, lblDue, lblDueValue;
