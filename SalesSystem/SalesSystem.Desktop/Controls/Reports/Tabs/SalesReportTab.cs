...
public class SalesReportTab : UserControl, IExportableReport
{
    ...
    public string GetReportName() => "طھظ‚ط±ظٹط± ط§ظ„ظ…ط¨ظٹط¹ط§طھ";
    ...
    private void UpdateSummary(List<SalesReportDto> list)
    {
        ...
        lblSummary.Text = $"ط¹ط¯ط¯ ط§ظ„ظپظˆط§طھظٹط±: {list.Count} | ط¥ط¬ظ…ط§ظ„ظٹ ط§ظ„ظ…ط¨ظٹط¹ط§طھ: {totalSales:N2} | ط§ظ„ظ…ط¯ظپظˆط¹: {totalPaid:N2} | ط§ظ„ظ…طھط¨ظ‚ظٹ: {totalDue:N2}";
    }
    ...
    private void FormatGrid()
    {
        ...
        SetHeader("CustomerName", "ط§ظ„ط¹ظ…ظٹظ„");
    ...
    private async Task ExportToExcelAsync()
    {
        ...
        try
        {
            ...
            var worksheet = workbook.Worksheets.Add("طھظ‚ط±ظٹط± ط§ظ„ظ…ط¨ظٹط¹ط§طھ");

            // Headers
            var headers = new[] { "ط±ظ‚ظ… ط§ظ„ظپط§طھظˆط±ط©", "ط§ظ„طھط§ط±ظٹط®", "ط§ظ„ط¹ظ…ظٹظ„", "ط§ظ„ط¥ط¬ظ…ط§ظ„ظٹ", "ط§ظ„ظ…ط¯ظپظˆط¹", "ط§ظ„ظ…طھط¨ظ‚ظٹ" };
            ...
            var dialog = new SaveFileDialog
            {
                ...
                FileName = $"طھظ‚ط±ظٹط±_ط§ظ„ظ…ط¨ظٹط¹ط§طھ_{DateTime.Now:yyyyMMdd}.xlsx"
            };
