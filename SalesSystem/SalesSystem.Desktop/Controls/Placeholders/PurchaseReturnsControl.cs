...
public partial class PurchaseReturnsControl : BaseModuleControl
{
    private readonly IPurchaseReturnApiService _apiService;
    ...
    private BindingList<PurchaseReturnDto> _returnList = new();

    public PurchaseReturnsControl(
        IPurchaseReturnApiService apiService,
    ...
    private void InitializeComponent()
    {
        ...
        this.btnNew.Text = "+ مرتجع مشتريات";
    ...
    private async Task RefreshData()
    {
        ...
        if (result.IsSuccess)
        {
            _returnList = new BindingList<PurchaseReturnDto>(result.Value.ToList());
    ...
    {
        using var diag = new PurchaseReturnForm(_apiService, _supplierApi, _productApi, _warehouseApi, _notification);
