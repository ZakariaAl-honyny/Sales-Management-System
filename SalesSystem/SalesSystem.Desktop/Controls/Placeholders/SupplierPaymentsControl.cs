...
public partial class SupplierPaymentsControl : BaseModuleControl
{
    ...
    private BindingList<SupplierPaymentDto> _paymentList = new();

    public SupplierPaymentsControl(
    ...
    private async Task RefreshData()
    {
        ...
        if (result.IsSuccess)
        {
            _paymentList = new BindingList<SupplierPaymentDto>(result.Value.ToList());
    ...
    {
        using var diag = new SupplierPaymentDialog(_apiService, _supplierApi, _notification);
