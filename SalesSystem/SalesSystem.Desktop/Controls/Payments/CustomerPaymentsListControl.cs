...
public partial class CustomerPaymentsListControl : UserControl
{
    ...
    private void SetupGrid()
    {
        ...
        dgvPayments.Columns.Add(new DataGridViewTextBoxColumn { DataPropertyName = "PaymentNumber", HeaderText = "رقم السند", Width = 120 });
        dgvPayments.Columns.Add(new DataGridViewTextBoxColumn { DataPropertyName = "PaymentDate", HeaderText = "التاريخ", Width = 100, DefaultCellStyle = new DataGridViewCellStyle { Format = "yyyy-MM-dd" } });
        dgvPayments.Columns.Add(new DataGridViewTextBoxColumn { DataPropertyName = "CustomerName", HeaderText = "العميل", AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill });
        dgvPayments.Columns.Add(new DataGridViewTextBoxColumn { DataPropertyName = "Amount", HeaderText = "المبلغ", Width = 100, DefaultCellStyle = new DataGridViewCellStyle { Format = "N2", ForeColor = Color.Green, Font = new Font(dgvPayments.Font, FontStyle.Bold) } });
        dgvPayments.Columns.Add(new DataGridViewTextBoxColumn { DataPropertyName = "InvoiceNo", HeaderText = "الفاتورة", Width = 120 });
    }
    ...
    private async Task LoadCustomers()
    {
        ...
        if (res.IsSuccess)
        {
            ...
            list.Insert(0, new CustomerDto(0, "", "الكل", "", "", "", 0, 0, 0, true));
    ...
    private void InitializeComponent()
    {
        ...
        btnNew = new Button { Text = "سند جديد", Width = 100, Height = 35, FlatStyle = FlatStyle.Flat, BackColor = Color.FromArgb(46, 204, 113), ForeColor = Color.White };
        btnNew.Click += (s, e) => { var dlg = _serviceProvider.GetRequiredService<CustomerPaymentDialog>(); dlg.ShowDialog(); };
        
        btnSearch = new Button { Text = "بحث", Width = 80, Height = 35, FlatStyle = FlatStyle.Flat };
        ...
        pnlTop.Controls.AddRange(new Control[] { btnNew, btnSearch, dtpTo, new Label { Text = "إلى:", AutoSize = true, Margin = new Padding(0, 7, 0, 0) }, dtpFrom, new Label { Text = "من:", AutoSize = true, Margin = new Padding(0, 7, 0, 0) }, cmbCustomerFilter, new Label { Text = "العميل:", AutoSize = true, Margin = new Padding(0, 7, 0, 0) } });
