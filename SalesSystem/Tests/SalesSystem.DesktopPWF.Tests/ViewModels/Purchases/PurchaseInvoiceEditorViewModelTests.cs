...
public class PurchaseInvoiceEditorViewModelTests : IDisposable
{
    ...
    {
        var invoice = new PurchaseInvoiceDto(1, 1, "مورد تجريبي", 1, "المستودع الرئيسي", DateTime.Today, null, 1, 1000m, 0, 0, 1000m, 1000m, 0, null, null, 1, new List<PurchaseInvoiceItemDto>
        {
