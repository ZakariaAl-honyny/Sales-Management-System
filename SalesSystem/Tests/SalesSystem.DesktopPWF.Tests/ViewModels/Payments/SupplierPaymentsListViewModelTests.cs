...
public class SupplierPaymentsListViewModelTests
{
    ...
    public SupplierPaymentsListViewModelTests()
    {
        ...
        var paymentServiceField = typeof(SupplierPaymentsListViewModel).GetField("_paymentService",
            System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        paymentServiceField?.SetValue(_viewModel, _mockPaymentService.Object);

        var supplierServiceField = typeof(SupplierPaymentsListViewModel).GetField("_supplierService",
            System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        supplierServiceField?.SetValue(_viewModel, _mockSupplierService.Object);

        var dialogServiceField = typeof(SupplierPaymentsListViewModel).GetField("_dialogService",
            System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
    ...
    public void SelectedPayment_Set_NotifiesPropertyChanged()
    {
        ...
        var payment = new SupplierPaymentDto(1, 1, "مورد", 100m, DateTime.Today, 1, "نقدي", "ملاحظات", DateTime.Today);
    ...
    public async Task LoadPaymentsAsync_WhenApiSucceeds_PopulatesPayments()
    {
        ...
        {
            new(1, 1, "مورد 1", 100m, DateTime.Today, 1, "نقدي", null, DateTime.Today),
            new(2, 2, "مورد 2", 200m, DateTime.Today, 1, "نقدي", null, DateTime.Today)
        };
    ...
    public async Task LoadPaymentsAsync_UpdatesTotalCount()
    {
        var payments = new List<SupplierPaymentDto>
        {
            new(1, 1, "مورد", 100m, DateTime.Today, 1, "نقدي", null, DateTime.Today)
        };
