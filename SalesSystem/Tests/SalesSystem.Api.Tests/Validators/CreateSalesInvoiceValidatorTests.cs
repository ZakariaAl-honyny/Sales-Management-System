...
using SalesSystem.Api.Validators.Sales;
using SalesSystem.Contracts.Enums;
using SalesSystem.Contracts.Requests;

namespace SalesSystem.Api.Tests.Validators;

public class CreateSalesInvoiceValidatorTests
{
    private readonly CreateSalesInvoiceValidator _validator = new();
    ...
    [Fact]
    public void GivenLargeNegativePaidAmount_WhenValidating_ThenFails()
    {
        // Arrange
        var request = CreateValidRequest() with { PaidAmount = -100m };
