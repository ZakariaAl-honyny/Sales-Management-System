...
public class ProductUnitTests
{
    ...
    {
        var unit = ProductUnit.CreateBaseUnit(1, unitId: (short)1);
    ...
    {
        Assert.Throws<DomainException>(() => ProductUnit.CreateBaseUnit(1, unitId: (short)0));
    }
    ...
    public void CreateDerivedUnit_FactorLessThanOrEqualToOne_ShouldThrow()
    {
        Assert.Throws<DomainException>(() =>
            ProductUnit.CreateDerivedUnit(1, unitId: (short)2, factor: 1));
        Assert.Throws<DomainException>(() =>
            ProductUnit.CreateDerivedUnit(1, unitId: (short)2, factor: 0.5m));
    }

    [Fact]
    public void CreateDerivedUnit_FactorMoreThanOne_ShouldSucceed()
    {
        var unit = ProductUnit.CreateDerivedUnit(1, unitId: (short)2, factor: 12);
    ...
    {
        var baseUnit = ProductUnit.CreateBaseUnit(1, unitId: (short)1);
        var derivedUnit = ProductUnit.CreateDerivedUnit(1, unitId: (short)2, factor: 12);
