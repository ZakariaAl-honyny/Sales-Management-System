...
public class CreateInventoryTransactionRequestValidator : AbstractValidator<CreateInventoryTransactionRequest>
{
    public CreateInventoryTransactionRequestValidator()
    {
        ...
        RuleFor(x => x.TransactionType).InclusiveBetween((byte)1, (byte)12).WithMessage("نوع المعاملة غير صالح");
        ...
        {
            line.RuleFor(l => l.ProductId).GreaterThan(0).WithMessage("المنتج مطلوب");
