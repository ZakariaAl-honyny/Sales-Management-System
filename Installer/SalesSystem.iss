...
Source: "..\SalesSystem\SalesSystem.DesktopPWF\bin\Release\net10.0-windows\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs; Check: not IsServiceOnly
; API / Windows Service
Source: "..\SalesSystem\SalesSystem.Api\bin\Release\net10.0-windows\*"; DestDir: "{app}\Service"; Flags: ignoreversion recursesubdirs createallsubdirs
; Configuration files
Source: "..\SalesSystem\SalesSystem.Api\appsettings.json"; DestDir: "{app}\Service"; Flags: ignoreversion
Source: "..\SalesSystem\SalesSystem.DesktopPWF\appsettings.json"; DestDir: "{app}"; Flags: ignoreversion

[Run]
; Register and start Windows Service
Filename: "sc.exe"; Parameters: "create ""SalesSystemService"" binPath=""{app}\Service\SalesSystem.Api.exe"" start=auto DisplayName=""نظام إدارة المبيعات"""; Flags: runhidden; StatusMsg: "جاري تثبيت خدمة النظام..."
Filename: "sc.exe"; Parameters: "description ""SalesSystemService"" ""خدمة نظام إدارة المبيعات والمخزون"""; Flags: runhidden
Filename: "sc.exe"; Parameters: "failure ""SalesSystemService"" reset=86400 actions=restart/5000/restart/10000/restart/15000"; Flags: runhidden
